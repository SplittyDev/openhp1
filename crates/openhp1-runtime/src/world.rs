...
pub use actor::{BossHealthUiState, FluffyHeadUiState, PlayerTravelState, PlayerUiState};
...
pub struct ScriptRuntime {
    ...
    particle_actors: HashSet<usize>,
    wind_actors: HashSet<usize>,
    pawn_actors: HashSet<usize>,
